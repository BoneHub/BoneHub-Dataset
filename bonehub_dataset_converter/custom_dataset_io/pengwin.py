...
label_mapping = {
    ...
    9: BLM.SACRUM.value,
    10: BLM.SACRUM.value,
    11: BLM.HIP_BONE_LEFT.value,
    12: BLM.HIP_BONE_LEFT.value,
    13: BLM.HIP_BONE_LEFT.value,
    14: BLM.HIP_BONE_LEFT.value,
    15: BLM.HIP_BONE_LEFT.value,
    16: BLM.HIP_BONE_LEFT.value,
    17: BLM.HIP_BONE_LEFT.value,
    18: BLM.HIP_BONE_LEFT.value,
    19: BLM.HIP_BONE_LEFT.value,
    20: BLM.HIP_BONE_LEFT.value,
    21: BLM.HIP_BONE_RIGHT.value,
    22: BLM.HIP_BONE_RIGHT.value,
    23: BLM.HIP_BONE_RIGHT.value,
    24: BLM.HIP_BONE_RIGHT.value,
    25: BLM.HIP_BONE_RIGHT.value,
    26: BLM.HIP_BONE_RIGHT.value,
    27: BLM.HIP_BONE_RIGHT.value,
    28: BLM.HIP_BONE_RIGHT.value,
    29: BLM.HIP_BONE_RIGHT.value,
    30: BLM.HIP_BONE_RIGHT.value,
}
...
def read_dataset(dataset_root: Path) -> list[DataSource]:
    ...
    for sub in subjects:
        ...
        fracture_counts = [
            ...
            (BLM.HIP_BONE_LEFT.name, np.sum((unique_labels >= 11) & (unique_labels <= 20)) - 1),
            (BLM.HIP_BONE_RIGHT.name, np.sum((unique_labels >= 21) & (unique_labels <= 30)) - 1),
        ]
        remarks = (
