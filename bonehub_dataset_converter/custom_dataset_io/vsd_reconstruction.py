...
label_mapping = {
    ...
    20: BLM.CUNEIFORM_MEDIAL_LEFT.value,
    21: BLM.CUNEIFORM_MEDIAL_RIGHT.value,
    22: BLM.CUNEIFORM_INTERMEDIATE_LEFT.value,
    23: BLM.CUNEIFORM_INTERMEDIATE_RIGHT.value,
    24: BLM.CUNEIFORM_LATERAL_LEFT.value,
    25: BLM.CUNEIFORM_LATERAL_RIGHT.value,
    ...
    36: BLM.PHALANX_FOOT_1_PROXIMAL_LEFT.value,
    37: BLM.PHALANX_FOOT_1_PROXIMAL_RIGHT.value,
    38: BLM.PHALANX_FOOT_1_DISTAL_LEFT.value,
    39: BLM.PHALANX_FOOT_1_DISTAL_RIGHT.value,
    40: BLM.PHALANX_FOOT_2_PROXIMAL_LEFT.value,
    41: BLM.PHALANX_FOOT_2_PROXIMAL_RIGHT.value,
    42: BLM.PHALANX_FOOT_2_MIDDLE_LEFT.value,
    43: BLM.PHALANX_FOOT_2_MIDDLE_RIGHT.value,
    44: BLM.PHALANX_FOOT_2_DISTAL_LEFT.value,
    45: BLM.PHALANX_FOOT_2_DISTAL_RIGHT.value,
    46: BLM.PHALANX_FOOT_3_PROXIMAL_LEFT.value,
    47: BLM.PHALANX_FOOT_3_PROXIMAL_RIGHT.value,
    48: BLM.PHALANX_FOOT_3_MIDDLE_LEFT.value,
    49: BLM.PHALANX_FOOT_3_MIDDLE_RIGHT.value,
    50: BLM.PHALANX_FOOT_3_DISTAL_LEFT.value,
    51: BLM.PHALANX_FOOT_3_DISTAL_RIGHT.value,
    52: BLM.PHALANX_FOOT_4_PROXIMAL_LEFT.value,
    53: BLM.PHALANX_FOOT_4_PROXIMAL_RIGHT.value,
    54: BLM.PHALANX_FOOT_4_MIDDLE_LEFT.value,
    55: BLM.PHALANX_FOOT_4_MIDDLE_RIGHT.value,
    56: BLM.PHALANX_FOOT_4_DISTAL_LEFT.value,
    57: BLM.PHALANX_FOOT_4_DISTAL_RIGHT.value,
    58: BLM.PHALANX_FOOT_5_PROXIMAL_LEFT.value,
    59: BLM.PHALANX_FOOT_5_PROXIMAL_RIGHT.value,
    60: BLM.PHALANX_FOOT_5_MIDDLE_LEFT.value,
    61: BLM.PHALANX_FOOT_5_MIDDLE_RIGHT.value,
    62: BLM.PHALANX_FOOT_5_DISTAL_LEFT.value,
    63: BLM.PHALANX_FOOT_5_DISTAL_RIGHT.value,
}

mesh_label_mapping = {
    "Sacrum": BLM.SACRUM.name,
    "Hip_L": BLM.HIP_BONE_LEFT.name,
    "Hip_R": BLM.HIP_BONE_RIGHT.name,
    ...
    "Medial_Cuneiform_L": BLM.CUNEIFORM_MEDIAL_LEFT.name,
    "Medial_Cuneiform_R": BLM.CUNEIFORM_MEDIAL_RIGHT.name,
    "Intermediate_Cuneiform_L": BLM.CUNEIFORM_INTERMEDIATE_LEFT.name,
    "Intermediate_Cuneiform_R": BLM.CUNEIFORM_INTERMEDIATE_RIGHT.name,
    "Lateral_Cuneiform_L": BLM.CUNEIFORM_LATERAL_LEFT.name,
    "Lateral_Cuneiform_R": BLM.CUNEIFORM_LATERAL_RIGHT.name,
    ...
    "Phalange_Foot_1_1_L": BLM.PHALANX_FOOT_1_PROXIMAL_LEFT.name,
    "Phalange_Foot_1_1_R": BLM.PHALANX_FOOT_1_PROXIMAL_RIGHT.name,
    "Phalange_Foot_1_2_L": BLM.PHALANX_FOOT_1_DISTAL_LEFT.name,
    "Phalange_Foot_1_2_R": BLM.PHALANX_FOOT_1_DISTAL_RIGHT.name,
    "Phalange_Foot_2_1_L": BLM.PHALANX_FOOT_2_PROXIMAL_LEFT.name,
    "Phalange_Foot_2_1_R": BLM.PHALANX_FOOT_2_PROXIMAL_RIGHT.name,
    "Phalange_Foot_2_2_L": BLM.PHALANX_FOOT_2_MIDDLE_LEFT.name,
    "Phalange_Foot_2_2_R": BLM.PHALANX_FOOT_2_MIDDLE_RIGHT.name,
    "Phalange_Foot_2_3_L": BLM.PHALANX_FOOT_2_DISTAL_LEFT.name,
    "Phalange_Foot_2_3_R": BLM.PHALANX_FOOT_2_DISTAL_RIGHT.name,
    "Phalange_Foot_3_1_L": BLM.PHALANX_FOOT_3_PROXIMAL_LEFT.name,
    "Phalange_Foot_3_1_R": BLM.PHALANX_FOOT_3_PROXIMAL_RIGHT.name,
    "Phalange_Foot_3_2_L": BLM.PHALANX_FOOT_3_MIDDLE_LEFT.name,
    "Phalange_Foot_3_2_R": BLM.PHALANX_FOOT_3_MIDDLE_RIGHT.name,
    "Phalange_Foot_3_3_L": BLM.PHALANX_FOOT_3_DISTAL_LEFT.name,
    "Phalange_Foot_3_3_R": BLM.PHALANX_FOOT_3_DISTAL_RIGHT.name,
    "Phalange_Foot_4_1_L": BLM.PHALANX_FOOT_4_PROXIMAL_LEFT.name,
    "Phalange_Foot_4_1_R": BLM.PHALANX_FOOT_4_PROXIMAL_RIGHT.name,
    "Phalange_Foot_4_2_L": BLM.PHALANX_FOOT_4_MIDDLE_LEFT.name,
    "Phalange_Foot_4_2_R": BLM.PHALANX_FOOT_4_MIDDLE_RIGHT.name,
    "Phalange_Foot_4_3_L": BLM.PHALANX_FOOT_4_DISTAL_LEFT.name,
    "Phalange_Foot_4_3_R": BLM.PHALANX_FOOT_4_DISTAL_RIGHT.name,
    "Phalange_Foot_5_1_L": BLM.PHALANX_FOOT_5_PROXIMAL_LEFT.name,
    "Phalange_Foot_5_1_R": BLM.PHALANX_FOOT_5_PROXIMAL_RIGHT.name,
    "Phalange_Foot_5_2_L": BLM.PHALANX_FOOT_5_MIDDLE_LEFT.name,
    "Phalange_Foot_5_2_R": BLM.PHALANX_FOOT_5_MIDDLE_RIGHT.name,
    "Phalange_Foot_5_3_L": BLM.PHALANX_FOOT_5_DISTAL_LEFT.name,
    "Phalange_Foot_5_3_R": BLM.PHALANX_FOOT_5_DISTAL_RIGHT.name,
}
